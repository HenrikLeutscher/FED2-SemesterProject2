...
loginForm.addEventListener("submit", async (event) => {
    ...
    if (!email || !password) {
        loginErrorMessageDiv.textContent = "Please ensure all fields are filled out.";
...
registerForm.addEventListener("submit", async (event) => {
    ...
    if (!registerEmail.endsWith("@stud.noroff.no")) {
        registerErrorMessageDiv.textContent = "Email must be a Noroff student email.";
    ...
    if (!registerUsername || !registerEmail || !registerPassword || !registerConfirmPassword) {
        registerErrorMessageDiv.textContent = "Please ensure all fields are filled out.";
        registerBtn.disabled = false;
        registerBtn.textContent = "Register";
        return;
    }
